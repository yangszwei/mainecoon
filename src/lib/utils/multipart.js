 ...
 * @returns {String}
 */
export function uint8ArrayToString(arr, offset, limit) {
	offset = offset || 0;
 ...
 */
export function containsToken(message, token, offset = 0) {
 ...
 */
export function findToken(message, token, offset = 0, maxSearchLength) {
 ...
 */
export function multipartEncode(datasets, boundary = guid(), contentType = 'application/dicom') {
